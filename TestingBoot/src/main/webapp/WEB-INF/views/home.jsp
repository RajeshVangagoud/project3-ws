...
<%--        <a href="#"> <img src="<c:url value="\images\post_1.jpg"/>" alt="Image placeholder"  class="img-fluid"/></a>
 --%>                     <a href="#"><img src="images/post_1.jpg" alt="Image placeholder" class="img-fluid"></a>
          ...
          <div class="col-sm-6 col-lg-4 mb-4">
            <div class="blog-entry">
              ...
              <a href="#">
<%--             <img src="<c:url value="\images\post_2.jpg"/>" alt="Image placeholder"  class="img-fluid"/></a>
 --%>               
          ...
          <div class="col-sm-6 col-lg-4 mb-4">
            <div class="blog-entry">
              <a href="#">
<%--              <img src="<c:url value="\images\post_3.jpg"/>" alt="Image placeholder"  class="img-fluid"/></a>
 --%>               <a href="#"><img src="images/post_3.jpg" alt="Image placeholder" class="img-fluid"></a>
      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    	             ...
    	             <script src="<c:url value="/js/vendor/jquery.min.js"/>" type="text/javascript"></script>
    	    	<script src="<c:url value="/js/vendor/popper.min.js"/>" type="text/javascript"></script>
    	    	<script src="<c:url value="/js/vendor/bootstrap.min.js"/>" type="text/javascript"></script>
    	    	<script src="<c:url value="/js/vendor/jquery.easing.1.3.js"/>" type="text/javascript"></script>
        	<script src="<c:url value="/js/vendor/jquery.stellar.min.js"/>" type="text/javascript"></script>
        	<script src="<c:url value="/js/vendor/jquery.waypoints.min.js"/>" type="text/javascript"></script>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
        	<script src="<c:url value="/js/google-map.js"/>" type="text/javascript"></script>
